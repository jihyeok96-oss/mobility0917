...
import com.oji.mobility.dto.BoardForm;
...
public interface BoardRepository extends JpaRepository<Board, Long>, BoardRepositoryCustom {
    ...
    Page<Board> findAllByIdOrderByIdDesc(Pageable pageable);

    Page<Board> findByTitleContainingIgnoreCaseOrContentsContainingIgnoreCase(String title, String content, Pageable pageable);
